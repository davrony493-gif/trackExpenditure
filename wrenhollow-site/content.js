...
window.WRENHOLLOW = {
  ...
  flight: {
    ...
    beats: [
      ...
      { id: "stills",     vh: 2.0, mvh: 1.6, from: 7,    to: 12.5, chapter: "stills" },
  ...
  chapters: {
    ...
    stills: {
      ...
      title: "Copper & steam",
      short: "Copper & steam",
      body: "The copper pot still runs slowly and every cut is made by hand. The distiller decides where the heart of each run begins and ends.",
  ...
  process: [
    ...
    { n: "03", title: "Copper", body: "The wash is run twice through the copper pot still and cut by hand." },
